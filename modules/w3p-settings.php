...
function w3p_settings() {
    ...
    <div class="wrap wrap--w3p">
        ...
        <?php $tab = isset( $_GET['tab'] ) ? (string) sanitize_text_field( wp_unslash( $_GET['tab'] ) ) : 'settings'; ?>

        <h2 class="nav-tab-wrapper">
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&amp;tab=settings' ) ); ?>" class="nav-tab <?php echo $tab === 'settings' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Settings', 'w3p-seo' ); ?></a>
            ...
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&amp;tab=tools' ) ); ?>" class="nav-tab <?php echo $tab === 'tools' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Tools', 'w3p-seo' ); ?></a>
        </h2>
        ...
        <?php if ( $tab === 'settings' ) {
            ...
            <div class="w3p-intro">
                ...
                <b>W3P</b> SEO <span class="w3p-intro--version"><?php echo esc_attr( W3P_VERSION ); ?></span>
            </div>

            <div class="w3p-ui-panel">
                <h3>Thank you for using W3P SEO!</h3>
                <p>W3P SEO aims to provide the required SEO options for any web developer.</p>
            ...
            <form method="post" action="">
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            <th scope="row"><label>Titles and Descriptions</label></th>
                            <td>
                                <p>
                        ...
                        <tr>
                            <th scope="row"><label>Sitemap</label></th>
                            <td>
                                <p>
                                    <input name="w3p_enable_sitemap" id="w3p_enable_sitemap" type="checkbox" value="1" <?php checked( 1, (int) get_option( 'w3p_enable_sitemap' ) ); ?>> <label for="w3p_enable_sitemap">Enable XML sitemap</label>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label>Schema</label></th>
                            <td>
                                <p>
                                ...
                                <p>
                                    <b>Note:</b> Use the <code>&lt;php if ( function_exists( 'w3p_breadcrumbs' ) ) { w3p_breadcrumbs(); } ?&gt;</code> template function to display microdata breadcrumbs. Note that they are displayed as an <code>ol/li</code> list, and are unstyled.
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th scope="row"><label>Advanced Settings</label></th>
                            <td>
                                <p>
                        ...
                        <tr>
                            <th scope="row"><label><?php esc_html_e( 'Shortcodes', 'w3p-seo' ); ?></label></th>
                            <td>
                                <p>
                                    <strong>List Subpages</strong>
                                    <br>Use the <code>[subpages]</code> shortcode to list the subpages of the current page as a <code>ul/li</code> list, allowing you to use parent pages in a similar way to categories. The <code>ul</code> structure is ready for styling using the <code>.w3p-subpages</code> CSS class.
                                </p>
                            </td>
                        </tr>
                    </tbody>
            ...
            <h3 class="nav-tab-wrapper">
                ...
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=w3p&tab=console&tab2=kg' ) ); ?>" class="nav-tab <?php echo $sub_tab === 'kg' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Knowledge Panel', 'w3p-seo' ); ?></a>
            ...
            if ( $sub_tab === 'verification' ) {
                ...
                <form method="post" action="">
                    ...
                    <p><span class="dashicons dashicons-editor-help"></span> This section allows you to verify ownership of your site with Google Search Console, Bing Webmaster Tools, and Pinterest.</p>
                    <p>
                ...
                <form method="post" action="">
                    ...
                    <p><span class="dashicons dashicons-editor-help"></span> This section allows you to control your local listing, your Knowledge Panel and various site schemas, such as <code>Organization</code> and <code>LocalBusiness</code>.</p>
                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><label>Postal Address: Country Code</label></th>
                                <td>
                                    <p>
                                        <input name="w3p_local_country_code" type="text" class="regular-text" maxlength="2" value="<?php echo esc_attr( get_option( 'w3p_local_country_code' ) ); ?>">
                                        <br><small>ISO 3166-1 alpha-2 code, e.g. <span>IE</span> for Ireland, <span>GB</span> for United Kingdom, <span>US</span> for United States.</small>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                ...
                if ( isset( $_POST['info_update'] ) ) {
                    ...
                    if ( $old_logo !== $new_logo ) {
                        if ( $old_logo ) {
                            delete_transient( 'w3p_kg_logo_dimensions_' . md5( $old_logo ) );
                            delete_transient( 'w3p_kg_logo_attachment_id_' . md5( $old_logo ) );
                        }
                        if ( $new_logo ) {
                            delete_transient( 'w3p_kg_logo_dimensions_' . md5( $new_logo ) );
                            delete_transient( 'w3p_kg_logo_attachment_id_' . md5( $new_logo ) );
                        }
                    }
                ...
                <form method="post" action="">
                    ...
                    <table class="form-table">
                        <tbody>
                            <tr>
                                <th scope="row" colspan="2"><h3><?php esc_html_e( 'Knowledge Panel &amp; Schema.org', 'w3p-seo' ); ?></h3></th>
                            </tr>
                            <tr>
                                <th scope="row">
            ...
            <?php
        } elseif ( (string) $tab === 'tools' ) {
            include 'w3p-settings-tools.php';
        }
        ?>
    </div>
    <?php
